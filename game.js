    ...
    var rpgGame = {
        ...
        startGame: function () {
            ...
            $(".character_button").on("click", function () {
                if (rpgGame.yourCharacter === "") {
                    ...
                    else if (this.id === "luke-skywalker") {
                        rpgGame.yourCharacter = lukeSkywalker;
                    }
            ...
            $(".enemies").on("click", function () {
                if (rpgGame.defender === "") {
                    ...
                    if (this.id === "obi-wan-kenobi") {
                        ...
                        rpgGame.defender = lukeSkywalker;
                    };
        ...
        restart: function () {
            ...
            $(".restart_button").on("click", function () {
                ...
                lukeSkywalker.healthPoints = 150;
                lukeSkywalker.attackPower = 12;
                ...
                // reset characters
                $("#characters").html("<h2 class='choose_character'>Choose your character</h2><button id='obi-wan-kenobi' class='character_button'><div class='name'>Obi-Wan-Kenobi</div><div class='character_pic'><img class='character_img' src='https://i.kinja-img.com/gawker-media/image/upload/s--6oBFTK_i--/c_scale,f_auto,fl_progressive,q_80,w_800/kz8kvwoedn6wtqlihjqu.jpg' alt='obi-wan-kenobi pic'></div><div class='character_hp'>HP: <span class='hp'>130</span></div></button><button id='emperor-palpatine' class='character_button'><div class='name'>Emperor Palpatine</div><div class='character_pic'><img class='character_img' src='http://athenaposters.ca/wp-content/uploads/2017/05/RP15502-Starwars-Emperor.jpg' alt='emperor paplatine pic'></div><div class='character_hp'>HP: <span class='hp'>120</span></div></button><button id='darth-vader' class='character_button'><div class='name'>Darth Vader</div><div class='character_pic'><img class='character_img' src='https://static.comicvine.com/uploads/original/6/68616/2204559-darth_vader_9837.jpg' alt='darth vader pic'></div><div class='character_hp'>HP: <span class='hp'>140</span></div></button><button id='lukeSkywalker' class='character_button'><div class='name'>Luke Skywalker</div><div class='character_pic'><img class='character_img' src='http://3.bp.blogspot.com/-JHhvFJLHiV0/T7VZVyQKqpI/AAAAAAAABA0/UxeQfUPGjqU/s1600/Luke+Skywalker.JPG' alt='skywalker pic'></div><div class='character_hp'>HP: <span class='hp'>150</span></div></button>");
